...
export const getAccountTypeIcon = (type: string) => {
  if (type.includes('instagram')) {
    return (
      <div className="w-6 h-6 bg-gradient-to-br from-orange-400 via-pink-500 to-purple-600 rounded flex items-center justify-center">
